...
import com.incarcloud.ics.core.servlet.ServletContextSupport;
...
public abstract class AbstractFilter extends ServletContextSupport implements Filter {
    ...
    private static transient final Logger log = Logger.getLogger(AbstractFilter.class.getName());
        ...
        try {
            ...
            if (e instanceof ServletException) {
                ...
                if (log.isLoggable(Level.SEVERE)) {
                    log.severe("Unable to start Filter: [" + e.getMessage() + "].");
                }
