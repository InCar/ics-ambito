CREATE TABLE IF NOT EXISTS `t_sys_org` (
  ...
  `org_code` varchar(50) NOT NULL COMMENT '组织code',
  `parent_code` varchar(50) COMMENT '父组织code',
  `parent_codes` varchar(1000) COMMENT '所有父组织codes',
  `email` varchar(50) NOT NULL DEFAULT '' COMMENT '邮件',
  `operate_type` tinyint(4) not null default 0 COMMENT '是否可操作 0=不可操作，1=可操作',
  `level` tinyint(4) NOT NULL DEFAULT 0 COMMENT '等级',
  `is_leaf` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否为叶子节点 0=非叶子节点，1=叶子结点',
  `full_name` varchar(100) NOT NULL DEFAULT '' COMMENT '机构全名',
