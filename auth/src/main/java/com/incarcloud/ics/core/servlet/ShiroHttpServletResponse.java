...
import com.incarcloud.ics.core.session.AmbitoHttpSession;
...
public class ShiroHttpServletResponse extends HttpServletResponseWrapper {
    ...
    private static final String DEFAULT_SESSION_ID_PARAMETER_NAME = AmbitoHttpSession.DEFAULT_SESSION_ID_NAME;
    ...
    public AmbitoHttpServletRequest getRequest() {
        return request;
    }

    @SuppressWarnings({"UnusedDeclaration"})
    public void setRequest(AmbitoHttpServletRequest request) {
        this.request = request;
    }
    ...
    protected boolean isEncodeable(final String location) {
        ...
        if (Boolean.FALSE.equals(request.getAttribute(AmbitoHttpServletRequest.SESSION_ID_URL_REWRITING_ENABLED)))
            return (false);
