...
public class AmbitoHttpSession implements HttpSession {
    ...
    public AmbitoHttpSession(Session session, HttpServletRequest currentRequest, ServletContext servletContext) {
    ...
    public boolean isNew() {
        Boolean value = (Boolean) currentRequest.getAttribute(AmbitoHttpServletRequest.REFERENCED_SESSION_IS_NEW);
